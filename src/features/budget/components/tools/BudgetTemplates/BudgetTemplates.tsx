...
import { DEFAULT_TEMPLATES, TEMPLATE_MAX_PREVIEW_CATEGORIES, TEMPLATE_PREVIEW_MODAL_WIDTH } from "../../../constants/budget.constants";
  ...
  return (
    <>
            ...
            <Col xs={24} sm={12} lg={8} key={template.id}>
              ...
              >
                ...
                <div className={templateStyles.templateTags}>
                  {template.categories.slice(0, TEMPLATE_MAX_PREVIEW_CATEGORIES).map((cat) => (
                    <CategoryTag
                      key={cat.name}
                  ...
                  {template.categories.length > TEMPLATE_MAX_PREVIEW_CATEGORIES && (
                    <Tag>{t("common.nMore", { count: template.categories.length - TEMPLATE_MAX_PREVIEW_CATEGORIES })}</Tag>
                  )}
                </div>
              </Card>
            </Col>
      ...
      <Modal
        ...
        width={TEMPLATE_PREVIEW_MODAL_WIDTH}
      >
        {previewTemplate && (
