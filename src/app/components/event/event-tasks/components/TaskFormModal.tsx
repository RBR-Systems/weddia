...
import type { Task, TaskFormValues, TaskCategory } from "../types/task.types";
import { TEAM_MEMBERS } from "../services/task.service";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Input maxLength={255} placeholder={t("tasks.form.titlePlaceholder")} />
        </Form.Item>

        <Form.Item name="description" label={t("common.description")}>
          <TextArea rows={3} placeholder={t("tasks.form.descriptionPlaceholder")} />
        </Form.Item>
        ...
        <Space style={{ width: "100%" }} size="middle">
          <Form.Item
            ...
            rules={[{ required: true, message: t("tasks.form.dueDateRequired") }]}
          >
          ...
          <Form.Item name="estimated_hours" label={t("tasks.form.estimatedHours")}>
        ...
        <Form.Item name="assignee_ids" label={t("tasks.form.assignees")}>
          <Select
            ...
            optionRender={(option) => {
              const member = TEAM_MEMBERS.find((m) => m.user_id === option.value);
              return (
                <Space>
                  <Avatar size={20} style={{ backgroundColor: "#c9a38c", fontSize: 10 }}>
        ...
        <Space>
          <Form.Item name="is_milestone" label={t("tasks.form.milestone")} valuePropName="checked">
            <Switch />
          </Form.Item>
