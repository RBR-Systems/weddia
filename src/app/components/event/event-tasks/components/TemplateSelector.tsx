...
import type { WeddingTemplate } from "../types/task.types";
import { fetchMexicanTemplate } from "../services/task.service";
  ...
  const templateCards: TemplateCardData[] = [
    {
      ...
      required_tasks:
        mexicanTemplate?.template_metadata.required_tasks ?? 171,
      optional_tasks:
        mexicanTemplate?.template_metadata.optional_tasks ?? 30,
